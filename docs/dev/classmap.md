...
| `App\Controller\Installer\ActionController` | `src/Controller/Installer/ActionController.php` | Streams or buffers installer action output based on configured mode | Accepts `INSTALLER_ACTION_MODE`; covered by `tests/Controller/Installer/ActionControllerTest.php` |
